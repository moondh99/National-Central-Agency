...
# -*- coding: utf-8 -*-
"""
부산파이낸셜뉴스 RSS 크롤링 프로그램
다양한 카테고리의 부산파이낸셜뉴스를 RSS 피드로 수집하여 CSV로 저장
"""
...
class BusanFinancialNewsCrawler:
    def __init__(self):
        ...
        self.rss_feeds = {
            ...
            "교육": "http://www.fnnews.com/rss/r20/fn_realnews_edu.xml",
            "피플": "http://www.fnnews.com/rss/r20/fn_realnews_people.xml",
            ...
            "의학과학": "http://www.fnnews.com/rss/r20/fn_realnews_medical.xml",
            "사설칼럼": "http://www.fnnews.com/rss/r20/fn_realnews_column.xml",
            "외부칼럼": "http://www.fnnews.com/rss/r20/fn_realnews_outcolumn.xml",
            "연예": "http://www.fnnews.com/rss/r20/fn_realnews_ent.xml",
            "스포츠": "http://www.fnnews.com/rss/r20/fn_realnews_sports.xml",
            "패션뷰티": "http://www.fnnews.com/rss/r20/fn_realnews_fasion.xml",
            "문화": "http://www.fnnews.com/rss/r20/fn_realnews_culture.xml",
            "블록포스트": "http://www.fnnews.com/rss/r20/fn_realnews_blockpost.xml"
        }
    ...
    def crawl_all_feeds(self):
        ...
        main_categories = ["정치", "경제", "증권", "금융", "부동산", "산업", "IT", "사회", "국제", "연예", "스포츠", "문화"]
    ...
    def save_to_csv(self, filename=None):
        ...
        if not filename:
            ...
            filename = f"results/busan_financial_news_articles_{timestamp}.csv"
