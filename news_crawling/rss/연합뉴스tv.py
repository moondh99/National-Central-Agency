...
# -*- coding: utf-8 -*-
"""
연합뉴스TV RSS 크롤링 프로그램 (RSS Description 활용)
본문 추출 차단 문제 해결 - RSS description 내용 활용
"""
...
class YonhapNewsTVCrawler:
    def __init__(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('yonhap_newstv_rss_crawler.log', encoding='utf-8'),
        ...
        self.rss_feeds = {
            ...
            "문화연예": "http://www.yonhapnewstv.co.kr/category/news/culture/feed/",
    ...
    def get_content_from_description(self, description):
        ...
        # 400자로 제한 (RSS description은 보통 짧음)
        if len(content) > 400:
            content = content[:400] + "..."
    ...
    def save_to_csv(self, filename=None):
        ...
        if not filename:
            ...
            filename = f"results/yonhap_newstv_articles_{timestamp}.csv"
