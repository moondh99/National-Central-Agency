...
class TongilNewsRSSCrawler:
    def __init__(self):
        ...
        self.rss_feeds = {
            ...
            '인기기사': 'https://www.tongilnews.com/rss/clickTop.xml',
            '현장소식': 'https://www.tongilnews.com/rss/S1N1.xml',
            '북한소식': 'https://www.tongilnews.com/rss/S1N2.xml',
            '민간교류': 'https://www.tongilnews.com/rss/S1N3.xml',
            '남북관계': 'https://www.tongilnews.com/rss/S1N4.xml',
            '북미관계': 'https://www.tongilnews.com/rss/S1N5.xml',
            '정부정책': 'https://www.tongilnews.com/rss/S1N6.xml',
            '해외동포': 'https://www.tongilnews.com/rss/S1N7.xml',
            '경협소식': 'https://www.tongilnews.com/rss/S1N8.xml',
            '오피니언': 'https://www.tongilnews.com/rss/S1N9.xml',
            '통일문화': 'https://www.tongilnews.com/rss/S1N10.xml',
            '특집연재': 'https://www.tongilnews.com/rss/S1N11.xml',
            '청소년': 'https://www.tongilnews.com/rss/S1N13.xml',
            '독자참여': 'https://www.tongilnews.com/rss/S1N14.xml',
            '캘린더': 'https://www.tongilnews.com/rss/S1N15.xml',
            '기타': 'https://www.tongilnews.com/rss/S1N16.xml',
            '동북아외신': 'https://www.tongilnews.com/rss/S1N18.xml'
        }
...
def main():
    ...
    print("1. 전체 카테고리 크롤링")
    print("2. 특정 카테고리 선택")
    print("3. 주요 카테고리만 (전체기사, 북한소식, 남북관계, 북미관계, 오피니언)")
    ...
    try:
        ...
        if choice == "1":
            ...
            filename = f"results/tongilnews_all_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
            ...
            try:
                ...
                filename = f"results/tongilnews_selected_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
            ...
            # 주요 카테고리만
            main_categories = ['전체기사', '북한소식', '남북관계', '북미관계', '오피니언']
            articles = crawler.crawl_specific_categories(main_categories, max_articles)
            filename = f"results/tongilnews_main_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
